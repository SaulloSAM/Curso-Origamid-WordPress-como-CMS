<?php
    ...
    function bikcraft_scripts () {
        ...
        // Cancelando o Registro do jQuery do WordPress
        wp_deregister_script("jquery");
        
        // Registrar Plugins [Array => Dependências]
    ...
    // Funções para Limpar o Header do WordPress
    ...
    // Registrar Menu
    function register_my_menu () { register_nav_menu ("menu-principal", __("Menu Principal")); }
    add_action ('init', 'register_my_menu');

    // Minha função para definir os tamanhos das imagens [large | medium]
    function my_custom_sizes () {
        add_image_size ("large", 1400, 380, true);
        add_image_size ("medium", 768, 380, true);
    }

    // Ativar a ação em relação a minha função.
